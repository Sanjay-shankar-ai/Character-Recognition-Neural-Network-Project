...
## Aim
To develop the neural network that recognize the character for the given dataset
...
## Dataset:
![Screenshot (3)](https://user-images.githubusercontent.com/94231938/205501041-03baf742-097e-4077-8b82-bee906afddab.png)
...
```
## OUTPUT
![Screenshot (2)](https://user-images.githubusercontent.com/94231938/205500181-89c2fe0a-9885-4716-b299-ee00c46042f2.png)

## Result
The program is executed by developing neural network,checked using Alphabet and also check the Model with other language charctacter like Gujarati
